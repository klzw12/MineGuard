...
public class AliyunSmsConfig {
    ...
    public Client aliyunSmsClient() {
        ...
        if (aliyunSmsProperties.getAccessKeyId() == null || aliyunSmsProperties.getAccessKeyId().isEmpty()) {
            ...
            throw new BaseException(ResultCodeEnum.PARAM_ERROR.getCode(), "阿里云短信服务配置错误：AccessKeyId不能为空");
        }
        ...
        if (aliyunSmsProperties.getAccessKeySecret() == null || aliyunSmsProperties.getAccessKeySecret().isEmpty()) {
            ...
            throw new BaseException(ResultCodeEnum.PARAM_ERROR.getCode(), "阿里云短信服务配置错误：AccessKeySecret不能为空");
        }
        ...
        try {
            ...
            throw new UserException(UserResultCode.OPERATION_FAILED, "阿里云短信服务初始化失败：" + e.getMessage());
        }
    }
}
