...
| 服务 | IP 地址 | 端口 | 重启策略 | 环境 |
|------|---------|------|----------|------|
| redis | 192.168.110.128 | 6379 | unless-stopped | 正式 |
| minio | 192.168.110.129 | 9000/9001 | unless-stopped | 正式 |
| rabbitmq | 192.168.110.130 | 5672/15672 | unless-stopped | 正式 |
| mongodb | 192.168.110.131 | 27017 | unless-stopped | 正式 |
| nacos | 192.168.110.132 | 8848/9848/9555 | unless-stopped | 正式 |
| redis-test | 192.168.110.133 | 6380 | no | 测试 |
| minio-test | 192.168.110.134 | 9002/9003 | no | 测试 |
| rabbitmq-test | 192.168.110.135 | 5673/15673 | no | 测试 |
| mongodb-test | 192.168.110.136 | 27018 | no | 测试 |
...
- **正式**: `redis://192.168.110.128:6379`
- **测试**: `redis://192.168.110.133:6380`
- **密码**: 请在容器配置中设置

### MinIO

- **正式**: `http://192.168.110.129:9000`
- **测试**: `http://192.168.110.134:9002`
- **控制台**: `http://192.168.110.129:9001`
- **账号**: 请在容器配置中设置
- **密码**: 请在容器配置中设置

### RabbitMQ

- **正式 AMQP**: `amqp://192.168.110.130:5672`
- **正式 管理控制台**: `http://192.168.110.130:15672`
- **测试 AMQP**: `amqp://192.168.110.135:5673`
- **测试 管理控制台**: `http://192.168.110.135:15673`
- **账号**: 请在容器配置中设置
- **密码**: 请在容器配置中设置

### MongoDB

- **正式**: `mongodb://192.168.110.131:27017`
- **测试**: `mongodb://192.168.110.136:27018`
- **账号**: 请在容器配置中设置
- **密码**: 请在容器配置中设置

### Nacos

- **地址**: `http://192.168.110.132:8848/nacos`
- **账号**: 请在容器配置中设置
- **密码**: 请在容器配置中设置
...
**访问控制台**：
- 正式环境: http://192.168.110.130:15672
- 测试环境: http://192.168.110.135:15673
- 账号: admin
- 密码: rabbitmqadmin
