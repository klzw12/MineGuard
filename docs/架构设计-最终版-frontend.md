...
- **管理端登录**：`pages/admin/login/index.uvue`
- **用户端登录**：`pages/user/login/index.uvue`
- **功能**：管理员/司机账号密码登录、身份验证
- **角色**：管理员、司机

### 3.2 首页

- **管理端首页**：`pages/admin/home/index.uvue`
- **用户端首页**：`pages/user/home/index.uvue`
- **功能**：数据概览、快捷操作
- **模块**：
