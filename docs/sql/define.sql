-- Active: 1772211149535@@127.0.0.1@3306@mineguard
-- =====================================================
-- MineGuard 用户域数据库设计
-- 模块: user-service
-- 版本: 1.1
...
CREATE TABLE IF NOT EXISTS `dispatch_task_transport` (
    ...
    `actual_cargo_weight` DECIMAL(10,2) COMMENT '实际货物重量(吨) - 后核算填写',
...
CREATE TABLE IF NOT EXISTS `driver_statistics` (
    ...
    `performance_score` DECIMAL(5,2) DEFAULT 100 COMMENT '绩效评分(0-100)',
    `fuel_cost` DECIMAL(12,2) DEFAULT 0 COMMENT '燃油成本',
    `toll_cost` DECIMAL(12,2) DEFAULT 0 COMMENT '过路费成本',
